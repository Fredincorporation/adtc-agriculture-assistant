#!/usr/bin/env python3
"""
ADTC 2026 - Offline Agriculture Assistant
Main inference script with offline RAG
"""
...
def ask(query: str, max_tokens: int = 600):
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Example: ./ask \"How can I control fall armyworm using low-cost methods?\"")
        sys.exit(1)
